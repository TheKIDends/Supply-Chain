...
export const PROFILE_PAGE = {
    ...
    PROFILE_PERSONAL_INFORMATION_PAGE: {
        ...
        ROLE_PLACEHOLDER: "Nhập chức danh",
        DESIGNATION: "Chức vụ",
        DESIGNATION_PLACEHOLDER: "Nhập chức vụ",
        BUSINESS_LICENSE_NUMBER: "Số giấy phép kinh doanh",
        BUSINESS_LICENSE_NUMBER_PLACEHOLDER: "Nhập số giấy phép kinh doanh",
        ADDRESS: "Địa chỉ gửi hàng",
        ADDRESS_PLACEHOLDER: "Nhập địa chỉ",
        REPRESENTATIVE: "Người đại diện",
        REPRESENTATIVE_PLACEHOLDER: "Nhập tên người đại diện",
