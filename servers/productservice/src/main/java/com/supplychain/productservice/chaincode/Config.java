package com.supplychain.productservice.chaincode;
...
public class Config {
    ...
    public static final String CA_ORG5_PEM_FILE = "../fabric/test-network/organizations/peerOrganizations/org5.example.com/ca/ca.org5.example.com-cert.pem";
    public static final String CA_ORG5_URL = "https://localhost:15054";

    public static final String CA_ORG6_PEM_FILE = "../fabric/test-network/organizations/peerOrganizations/org6.example.com/ca/ca.org6.example.com-cert.pem";
    ...
    public static final String ORG5_CONNECTION_PROFILE_PATH = "../fabric/test-network/organizations/peerOrganizations/org5.example.com/connection-org5.json";
    public static final String ORG6_CONNECTION_PROFILE_PATH = "../fabric/test-network/organizations/peerOrganizations/org6.example.com/connection-org6.json";
